class BusquedaVueltaAtras:
    def __init__(self, variables, dominios, restricciones):
        ...
        self.solucion = {}  # Diccionario para almacenar la solución encontrada

    def resolver(self):
        self.solucion = self.backtracking({})
...
busqueda_vuelta_atras = BusquedaVueltaAtras(variables, dominios, restricciones)
solucion = busqueda_vuelta_atras.resolver()
